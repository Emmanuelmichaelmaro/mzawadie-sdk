...
import { ICheckoutModel, IJobsModel, IPaymentModel, LocalStorageItems } from "./types";
...
export class LocalStorageHandler extends LocalStorageHandlerProxy {
    ...
    static getJobs(): IJobsModel | null {
        return LocalStorageHandlerProxy.retrieveObject(LocalStorageItems.JOB_QUEUE_CHECKOUT);
    }
