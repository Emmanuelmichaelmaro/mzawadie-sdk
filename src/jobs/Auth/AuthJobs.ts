...
export class AuthJobs extends JobsHandler<AuthJobsEventsValues> {
    ...
    resetPasswordRequest = async ({
        ...
        const { error } = await this.apolloClientManager.resetPasswordRequest(email, redirectUrl);
    ...
    signIn = async ({
        ...
        const { data, error } = await this.apolloClientManager.signIn(email, password);
