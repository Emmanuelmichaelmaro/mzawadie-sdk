...
export type Options<T extends keyof APIProxy> = APIProxy[T] extends (_: any, options: infer V) => any
    ? V
    : never;
...
export type WatchQueryReturnData<T extends keyof APIProxy> = APIProxy[T] extends (
    _: any,
    options: infer O
) => any
