...
class APIProxy {
    ...
    getOrderDetails = (
        ...
        > & {
            onUpdate: (
                data: OrderByToken["orderByToken"] | UserOrderByToken["orderByToken"] | null
            ) => void;
        }
    ) => {
        if (this.isLoggedIn()) {
            return this.watchQuery(QUERIES.OrderDetailsByUser, (data) => data.orderByToken)(
                variables,
                options
            );
        }
    ...
    setAccountUpdate = this.fireQuery(MUTATIONS.AccountUpdate, (data) => data!.accountUpdate);
    ...
    setPassword = async (
        ...
        result = await this.fireQuery(MUTATIONS.SetPassword, (data) => data!)(variables, {
            ...options,
    ...
    setPasswordChange = async (
        ...
        result = await this.fireQuery(MUTATIONS.PasswordChange, (data) => data!)(variables, {
            ...options,
            fetchPolicy: "no-cache",
        });
        const { data } = result;
