...
export interface UpdateUserAddress_accountAddressUpdate_address_country {
    __typename: "CountryDisplay";
    code: string;
    country: string;
}

export interface UpdateUserAddress_accountAddressUpdate_address {
    __typename: "Address";
    id: string;
    firstName: string;
    lastName: string;
    ...
    city: string;
    postalCode: string;
    country: UpdateUserAddress_accountAddressUpdate_address_country;
    countryArea: string;
    phone: string | null;
...
export interface UpdateUserAddress_accountAddressUpdate {
    ...
    address: UpdateUserAddress_accountAddressUpdate_address | null;
