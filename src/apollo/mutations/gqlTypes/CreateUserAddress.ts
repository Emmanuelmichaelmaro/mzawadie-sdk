...
export interface CreateUserAddress_accountAddressCreate_address_country {
    __typename: "CountryDisplay";
    code: string;
    country: string;
}

export interface CreateUserAddress_accountAddressCreate_address {
    __typename: "Address";
    id: string;
    firstName: string;
    lastName: string;
    ...
    city: string;
    postalCode: string;
    country: CreateUserAddress_accountAddressCreate_address_country;
    countryArea: string;
    phone: string | null;
...
export interface CreateUserAddress_accountAddressCreate {
    ...
    address: CreateUserAddress_accountAddressCreate_address | null;
